...
public class Coder extends NoopVisitor
{
	...
	public Coder(HashMap<String, SymEntry> symTab) {
		this.symTab = symTab;
	}
	...
	void printPrefix() {
		System.out.println("\t.cpu arm1176jzf-s");
		System.out.println("\t.eabi_attribute 20, 1");
		System.out.println("\t.eabi_attribute 21, 1");
		System.out.println("\t.eabi_attribute 23, 3");
		System.out.println("\t.eabi_attribute 24, 1");
		System.out.println("\t.eabi_attribute 25, 1");
		System.out.println("\t.eabi_attribute 26, 1");
		System.out.println("\t.eabi_attribute 30, 6");
		System.out.println("\t.eabi_attribute 34, 1");
		System.out.println("\t.eabi_attribute 18, 4");
		System.out.println("\t.file	\"gustave.S\"");
		System.out.println("\t.global	__aeabi_idiv");
		System.out.println("\t.section	.text.gustave,\"ax\",%progbits");
		System.out.println("\t.align	2");
		System.out.println("\t.global	gustave");
		System.out.println("\t.syntax unified");
		System.out.println("\t.arm");
		System.out.println("\t.fpu softvfp");
		System.out.println("\t.type	gustave, %function");
		System.out.println("gustave:");
		System.out.println("\t@ args = 0, pretend = 0, frame = 16");
		System.out.println("\t@ frame_needed = 1, uses_anonymous_args = 0");
		System.out.println("\tpush	{fp, lr}");
		System.out.println("\tadd	fp, sp, #4");
		System.out.println("\tsub	sp, sp, #16");
		System.out.println("\tldr	r0, =F_intro");
	...
	public void visit(AccessStmt n) {
		...
		//((MethodEntry) symTab.get(n.feature)).locals
		System.out.println("\tbl\tM_" + n.feature);
	}
