             ...
             implements BSTInterface<T>
{
  ...
  /**
   * Returns the left most leaf in the tree
   * @return Info of left most leaf
   */
  ...
  /**
   * Returns the right most leaf in the tree
   * @return Info of right most leaft
   */
  ...
  /**
   * Starts recursion to print all leaves
   */
  ...
  /**
   * Recursively looks for and prints all leaves
   * @param node Last checked node
   */
  public void findLeaves(BSTNode<T> node) {
	  ...
	  if(node.getRight() == null && node.getLeft() == null) {
		  System.out.println("Leaf: " + node.getInfo());
	  }
  }
  
  /**
   * Counts all elements with a specific info
   * @param element Data to check against
